...
window.addEventListener('DOMContentLoaded', (event) => {
    // Kiểm tra xem hàm showGame có tồn tại không để tránh lỗi
    if (typeof showGame === "function") {
        showGame('calculator'); // Mở máy tính ngay lập tức
        
        // Thêm class active cho nút bấm tương ứng để đẹp mắt
        const btnCalc = document.querySelector("button[onclick=\"showGame('calculator')\"]");
